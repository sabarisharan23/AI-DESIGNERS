...
export default function ColorPalette() {
  return (
    ...
    <div className="text-lg py-4">
      ...
      <Link
          to={"https://firefly.adobe.com/inspire/images?ff_channel=adobe_com&ff_campaign=feature_page&ff_source=firefly_seo"}
      ...
      <p className="font-semibold text-lg mb-6">This is the prompt home page of Adobe firefly where you can generate images using prompts.</p>
      <p className="font-semibold text-lg mb-6">The Prompt given in the below example: </p>
      ...
      <div>
        ...
        <p className="font-semibold text-lg mb-6">This is the output for the given prompt.</p>
        <div>
          <img
            src="/adobefinal.jpg"
            className="py-6 w-{300px}"
        ...
        <p className="font-semibold text-lg mb-6">Here is the slight change in the prompt "bike" to "motorcycle"</p>
        <div>
          <img
          ...
          ></img>
            ...
            <p className="font-semibold text-lg mb-6">Moreover there are many other options available for editing.</p>
