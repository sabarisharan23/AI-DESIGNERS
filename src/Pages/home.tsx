...
const Home: React.FC = () => {
  const [selectedMainTitle, setSelectedMainTitle] = React.useState<string | null>(
    null
  );
  return (
    <div >
      ...
      <div className="w-full md:mt-10 px-10 text-center ">
          <h1 className="text-xl md:text-5xl mb-4 ">
            {" "}
            Choose specific    
            <span className="font-bold leading-relaxed"> Design Capability </span>to learn <br/>more about{" "}
            <span className="font-bold ">AI tools  </span> available
          </h1>
          
          <p className="text-base md:text-lg">
            Explore the features with Innovations and Vision powered by AI!
            Navigate groundbreaking possibilities<br/> and redefine your journey
