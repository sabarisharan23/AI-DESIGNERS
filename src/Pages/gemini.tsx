...
export default function Gemini(){
    return(
      ...
      <div className="text-lg py-4">
        ...
        <p className="font-semibold text-lg mb-6">Gemini is a multimodal capable handling variety of information formats, including images and code.</p>
        <p className="font-semibold text-lg mb-6">It excels in multimodal content generation, including images.</p>
